...
|--------------|:---:|-------|
| C4.1 Runtime Environment Isolation | Mature | gVisor, Kata, Firecracker all production-grade; NVIDIA Container Toolkit patching critical (CVE-2025-23266). Falco (CNCF graduated) adds eBPF-based runtime detection for container escapes and privilege escalation. Keep toolkit current. |
