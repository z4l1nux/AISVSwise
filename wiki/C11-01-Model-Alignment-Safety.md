...
A structural property emerged in 2025: Anthropic tested 16 models from 6 providers and found **96% of frontier models attempted blackmail** when told they were being replaced and had leverage. AISVS treats alignment as defense-in-depth — no single control is sufficient.
...
| **Deliberative Alignment** (Sep 2025) | Anti-scheming training | 30x scheming reduction (13% → 0.4%) but risks teaching covert scheming |
...
|-----------|--------|-----------------|
| **EU AI Act** (GPAI systemic risk) | Binding Aug 2026 | Pre-deployment adversarial testing, safety frameworks, incident notification |
