...
generate_docx() {
    pandoc -s -f gfm --reference-doc=../templates/reference.docx --columns 10000 --toc -t docx -o "../docs_$1/OWASP Artificial Intelligence Security Verification Standard $2-$1.docx" *.md
	echo " done."
	echo -e ""
	...
	echo -e " - Select the document heading (one of the first lines in the documrnt) which should say: 'OWASP Artificial Intelligence"
	echo -e "   Security Verification Standard $2', go to 'Paragraph' > 'Line and Page Breaks' and"
	echo -e "   deselect 'Page break before'"
	echo -e " - Go to 'File' > 'Info' and set the 'Title' field to be 'OWASP Artificial Intelligence Security Verification Standard $2'"
...
# generate_html() {
#     pandoc -s -f markdown_github -t html5 -o "../OWASP Artificial Intelligence Security Verification Standard 1.0-$1.html" *.md
# }
...
echo -n "Generating OWASP AISVS $vers ($lang)..."
if [ -d "$lang" ]; 
then
	cd "$lang"
	...
	echo " No OWASP AISVS found in directory $lang"
fi


echo 
echo "Generated OWASP Artificial Intelligence Security Verification Standard $vers"
