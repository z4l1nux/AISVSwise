...
**Core Security Goal:** Only authorized, validated models reach production through controlled processes that maintain integrity, traceability, and recoverability.
...
| # | Description | Level | Role |
|:--------:|---------------------------------------------------------------------------------------------------------------------|:---:|:---:|
| **3.4.1** | **Verify that** all model changes (deployment, configuration, retirement) generate immutable audit records including timestamp, authenticated actor identity, change type, and before/after states. | 1 | V |
| **3.4.2** | **Verify that** audit log access requires appropriate authorization and all access attempts are logged with user identity and timestamp. | 2 | D/V |
...
| # | Description | Level | Role |
|:--------:|---------------------------------------------------------------------------------------------------------------------|:---:|:---:|
| **3.5.1** | **Verify that** model development, testing, and production environments are physically or logically separated with no shared infrastructure, distinct access controls, and isolated data stores. | 1 | D |
...
Models must be securely retired when no longer needed or when security issues are identified.
